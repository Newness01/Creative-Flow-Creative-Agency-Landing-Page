...
<p className='font-semibold text-gray-800 text-sm'>
    ...
    <h1 className='text-lg mt-6 font-bold text-gray-900 hover:text-blue-700 transition-all duration-300
    cursor-pointer'>{title} </h1>
    {/* Read more button */}
    <button className='relative inline-block mt-8 cursor-pointer group'>
        <span className='inline-flex items-center gap-2 text-sm font-semibold tracking-[2px] uppercase
        text-[#1a1a1a]'>READ MORE
        <FiArrowDownRight className='text-[#b79d7b] text-xl transition-transform duration-300
